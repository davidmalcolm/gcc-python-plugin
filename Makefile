...
GCC_C_API_SOURCE_FILES = \
  gcc-c-api/gcc-callgraph.c \
  gcc-c-api/gcc-cfg.c \
  gcc-c-api/gcc-constant.c \
  gcc-c-api/gcc-declaration.c \
  gcc-c-api/gcc-function.c \
  gcc-c-api/gcc-gimple.c \
  gcc-c-api/gcc-location.c \
  gcc-c-api/gcc-rtl.c \
  gcc-c-api/gcc-tree.c \
  gcc-c-api/gcc-type.c \
  gcc-c-api/gcc-variable.c

GCC_C_API_OBJECT_FILES:= $(patsubst %.c,%.o,$(GCC_C_API_SOURCE_FILES))
...
GCC_C_API_SOURCE_XML:= \
  gcc-c-api/callgraph.xml \
  gcc-c-api/cfg.xml \
  gcc-c-api/constant.xml \
  gcc-c-api/declaration.xml \
  gcc-c-api/function.xml \
  gcc-c-api/gimple.xml \
  gcc-c-api/location.xml \
  gcc-c-api/rtl.xml \
  gcc-c-api/tree.xml \
  gcc-c-api/type.xml \
  gcc-c-api/variable.xml

GCC_C_API_GENERATED_HEADERS:= \
...
PLUGIN_OBJECT_FILES:= $(PLUGIN_OBJECT_SOURCE_FILES) $(PLUGIN_OBJECT_GENERATED_FILES) $(GCC_C_API_OBJECT_FILES)
...
$(PLUGIN_OBJECT_SOURCE_FILES): %.o: $(srcdir)%.c autogenerated-config.h $(srcdir)gcc-python.h $(GCC_C_API_GENERATED_HEADERS)
	$(COMPILE.c) $(OUTPUT_OPTION) $<

clean:
	$(RM) *.so *.o gcc-c-api/*.o autogenerated* $(GCC_C_API_GENERATED_HEADERS)
	$(RM) -r docs/_build
...
$(GCC_C_API_GENERATED_HEADERS): $(GCC_C_API_SOURCE_XML) gcc-c-api/xml-to-h.py gcc-c-api/xmltypes.py
	cd $(srcdir)gcc-c-api && $(PYTHON) xml-to-h.py
