...
GCC_C_API_SO	:= gcc-c-api/gcc-c-api.so
...
$(GCC_PYTHON_PLUGIN_SO): $(PLUGIN_OBJECT_FILES) $(GCC_C_API_SO)
...
$(PLUGIN_OBJECT_SOURCE_FILES) $(PLUGIN_OBJECT_GENERATED_FILES): %.o: $(srcdir)%.c autogenerated-config.h $(srcdir)gcc-python.h $(GCC_C_API_SO) autogenerated-EXTRA_CFLAGS.txt
