...
{
    return gcc_python_string_from_string(gcc_location_get_filename(self->loc));
}
""")
...
{
    return gcc_python_int_from_long(gcc_location_get_line(self->loc));
}
""")
...
{
    return gcc_python_int_from_long(gcc_location_get_column(self->loc));
}
""")
