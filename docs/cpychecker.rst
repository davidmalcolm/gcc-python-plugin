...
`PyObject_CallFunction <http://docs.python.org/c-api/object.html#PyObject_CallFunction>`_,
`_PyObject_CallFunction_SizeT <http://docs.python.org/c-api/object.html#PyObject_CallFunction>`_,
`PyObject_CallFunctionObjArgs <http://docs.python.org/c-api/object.html#PyObject_CallFunctionObjArgs>`_,
`PyObject_CallMethod <http://docs.python.org/c-api/object.html#PyObject_CallMethod>`_,
